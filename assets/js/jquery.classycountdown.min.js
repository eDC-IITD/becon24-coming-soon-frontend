...
(function (c) {
    c.fn.ClassyCountdown = function (k, r) {
        ...
        function m() {
            ...
            a.find(".ClassyCountdown-days input").val(e).trigger("change");
            a.find(".ClassyCountdown-hours input").val(f).trigger("change");
            a.find(".ClassyCountdown-minutes input").val(g).trigger("change");
            a.find(".ClassyCountdown-seconds input").val(h).trigger("change");
        ...
        function p() {
            a.find(".ClassyCountdown-call-to-action > div").each(function () {
        ...
        (function () {
            ...
            a.find(".ClassyCountdown-call-to-action > div").attr("style", b.style.element);
